 ...
 * </ul>
 *
 * Falling back rather than failing is deliberate for the one secret this service
 * needs: the presence internal API key only gates the connection LOOKUP during
 * delivery. Without it, live push degrades (recipients read from history and get
 * offline notifications) — much better than a service that refuses to start.
 *
 ...
 *
 * Duplicated (bar the package) in the presence service, like KafkaSecurity, for
